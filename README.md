...
| Versão | `2.0.0-alpha.95` | `public/js/version.js` e `package.json` (batem) |
...
`package.json` tem **90 scripts**. Vários trazem uma chave `//nome` logo acima com o motivo de existirem — é onde mora o porquê.
