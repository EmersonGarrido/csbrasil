...
|---|---:|---|
| Código do jogo | 27.661 linhas em 34 arquivos | `cat public/js/*.js \| wc -l` |
| `game.js` | **6.454** linhas | `wc -l public/js/game.js` |
...
| Versão | `2.0.0-alpha.88` | `public/js/version.js` e `package.json` (batem) |
