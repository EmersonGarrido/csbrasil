...
|---|---:|---|
| Código do jogo | 28.736 linhas em 37 arquivos | `cat public/js/*.js \| wc -l` |
| `game.js` | **6.483** linhas | `wc -l public/js/game.js` |
| `main.js` | 2.035 linhas | `wc -l public/js/main.js` |
...
| Versão | `2.0.0-alpha.120` | `public/js/version.js` e `package.json` (batem) |
