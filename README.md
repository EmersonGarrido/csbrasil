...
|---|---:|---|
| Código do jogo | 25.269 linhas em 28 arquivos | `cat public/js/*.js \| wc -l` |
| `game.js` | **6.527** linhas | `wc -l public/js/game.js` |
| `main.js` | 1.597 linhas | `wc -l public/js/main.js` |
...
| Versão | `2.0.0-alpha.22` | `public/js/version.js` e `package.json` (batem) |
