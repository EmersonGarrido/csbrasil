...
|---|---:|---|
| Código do jogo | 30.118 linhas em 40 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6.521** linhas | `wc -l public/js/game.js` |
| `main.js` | 2.575 linhas | `wc -l public/js/main.js` |
...
| Versão | `2.0.0-alpha.142` | `public/js/version.js` e `package.json` (batem) |
