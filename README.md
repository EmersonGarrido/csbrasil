...
|---|---:|---|
| Código do jogo | 31.726 linhas em 44 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6.839** linhas | `wc -l public/js/game.js` |
| `main.js` | 2.641 linhas | `wc -l public/js/main.js` |
