...
|---|---:|---|
| Código do jogo | 29.599 linhas em 39 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6.559** linhas | `wc -l public/js/game.js` |
| `main.js` | 2.471 linhas | `wc -l public/js/main.js` |
