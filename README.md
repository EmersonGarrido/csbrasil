...
|---|---:|---|
| Código do jogo | 31.380 linhas em 44 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6.531** linhas | `wc -l public/js/game.js` |
| `main.js` | 2.589 linhas | `wc -l public/js/main.js` |
...
| Versão | `2.0.0-alpha.162` | `public/js/version.js` e `package.json` (batem) |
