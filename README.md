...
|---|---:|---|
| Código do jogo | 27.709 linhas em 34 arquivos | `cat public/js/*.js \| wc -l` |
| `game.js` | **6.465** linhas | `wc -l public/js/game.js` |
...
| Versão | `2.0.0-alpha.90` | `public/js/version.js` e `package.json` (batem) |
