...
|---|---:|---|
| Código do jogo | 31.758 linhas em 44 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6.854** linhas | `wc -l public/js/game.js` |
| `main.js` | 2.658 linhas | `wc -l public/js/main.js` |
