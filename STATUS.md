...
- **Versão:** `2.0.0-alpha.265`
- **Conteúdo jogável:** 6 facções, 53 personagens, 17 mapas e 26 armas com GLB
- **Código do jogo:** 48.426 linhas em 96 módulos JavaScript
- **Automação:** 243 comandos npm, 385 scripts de avaliação e 76 scripts de pipeline
