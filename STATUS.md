...
- **Versão:** `2.0.0-alpha.276`
- **Conteúdo jogável:** 6 facções, 53 personagens, 17 mapas e 26 armas com GLB
- **Código do jogo:** 49.028 linhas em 96 módulos JavaScript
- **Automação:** 249 comandos npm, 402 scripts de avaliação e 76 scripts de pipeline
