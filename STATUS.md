...
- **Versão:** `2.0.0-alpha.269`
- **Conteúdo jogável:** 6 facções, 53 personagens, 17 mapas e 26 armas com GLB
- **Código do jogo:** 48.924 linhas em 96 módulos JavaScript
- **Automação:** 244 comandos npm, 391 scripts de avaliação e 80 scripts de pipeline
