...
- **Versão:** `2.0.0-alpha.261`
- **Conteúdo jogável:** 6 facções, 53 personagens, 17 mapas e 26 armas com GLB
- **Código do jogo:** 47.772 linhas em 96 módulos JavaScript
- **Automação:** 242 comandos npm, 377 scripts de avaliação e 76 scripts de pipeline
