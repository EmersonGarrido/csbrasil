...
- **Versão:** `2.0.0-alpha.278`
- **Conteúdo jogável:** 6 facções, 53 personagens, 17 mapas e 26 armas com GLB
- **Código do jogo:** 49.192 linhas em 96 módulos JavaScript
- **Automação:** 251 comandos npm, 409 scripts de avaliação e 76 scripts de pipeline
