...
- **Versão:** `2.0.0-alpha.253`
- **Conteúdo jogável:** 6 facções, 53 personagens, 17 mapas e 26 armas com GLB
- **Código do jogo:** 47.570 linhas em 96 módulos JavaScript
- **Automação:** 242 comandos npm, 374 scripts de avaliação e 79 scripts de pipeline
