...
- **Versão:** `2.0.0-alpha.267`
- **Conteúdo jogável:** 6 facções, 53 personagens, 17 mapas e 26 armas com GLB
- **Código do jogo:** 48.478 linhas em 96 módulos JavaScript
- **Automação:** 244 comandos npm, 383 scripts de avaliação e 76 scripts de pipeline
