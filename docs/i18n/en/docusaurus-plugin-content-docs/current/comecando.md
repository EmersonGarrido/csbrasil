...
|---|---:|---|
| Game code | 29,605 lines in 39 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6,557** lines | `wc -l public/js/game.js` |
| `main.js` | 2,479 lines | `wc -l public/js/main.js` |
