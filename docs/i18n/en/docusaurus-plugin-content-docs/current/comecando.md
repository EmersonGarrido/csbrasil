...
|---|---:|---|
| Game code | 31,380 lines in 44 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6,531** lines | `wc -l public/js/game.js` |
| `main.js` | 2,589 lines | `wc -l public/js/main.js` |
...
| Version | `2.0.0-alpha.162` | `public/js/version.js` and `package.json` (match) |
