...
|---|---:|---|
| Game code | 31,352 lines in 44 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Version | `2.0.0-alpha.147` | `public/js/version.js` and `package.json` (match) |
...
`package.json` has **110 scripts**. Keys prefixed with `//` explain why the adjacent command exists.
