...
|---|---|---|---|---:|
| `awp_map` | Praça dos Três Poderes | rounds | `map_brasilia.js` | 1.775 |
| `fy_pool_day` | Piscina da Treta | rounds | `—` | — |
| `fy_havan` | Loja H (Estacionamento) | **capture** | `map_havan.js` | 1.866 |
| `fy_ferrovelho` | Ferro Velho do Zé | **capture** | `map_ferrovelho.js` | 1.837 |
| `fy_quebrada` | Quebrada (Rua do Baile) | **capture** | `map_quebrada.js` | 1.319 |
