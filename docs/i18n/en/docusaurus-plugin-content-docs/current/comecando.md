...
|---|---:|---|
| Game code | 29,575 lines in 39 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6,558** lines | `wc -l public/js/game.js` |
| `main.js` | 2,448 lines | `wc -l public/js/main.js` |
...
| Version | `2.0.0-alpha.126` | `public/js/version.js` and `package.json` (match) |
