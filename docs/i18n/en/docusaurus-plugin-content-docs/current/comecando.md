...
|---|---:|---|
| Game code | 27,324 lines in 33 files | `cat public/js/*.js \| wc -l` |
| `game.js` | **6,288** lines | `wc -l public/js/game.js` |
| `main.js` | 1,949 lines | `wc -l public/js/main.js` |
...
| Harness scripts | 171 | `ls tools/eval/*.mjs tools/eval/*.py \| wc -l` |
...
`package.json` has **69 scripts**. Keys prefixed with `//` explain why the adjacent command exists.
