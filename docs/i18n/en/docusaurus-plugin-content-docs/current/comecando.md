...
|---|---:|---|
| Game code | 47,611 lines in 96 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,494** lines | `wc -l public/js/game.js` |
| `main.js` | 3,543 lines | `wc -l public/js/main.js` |
...
| Version | `2.0.0-alpha.261` | `public/js/version.js` and `package.json` (match) |
