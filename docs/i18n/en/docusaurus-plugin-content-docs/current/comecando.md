...
|---|---:|---|
| Game code | 29,578 lines in 39 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6,517** lines | `wc -l public/js/game.js` |
| `main.js` | 2,478 lines | `wc -l public/js/main.js` |
...
| Version | `2.0.0-alpha.130` | `public/js/version.js` and `package.json` (match) |
...
`package.json` has **103 scripts**. Keys prefixed with `//` explain why the adjacent command exists.
