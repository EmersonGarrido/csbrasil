...
|---|---:|---|
| Game code | 49,885 lines in 97 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,493** lines | `wc -l public/js/game.js` |
| `main.js` | 3,596 lines | `wc -l public/js/main.js` |
...
| Version | `2.0.0-alpha.282` | `public/js/version.js` and `package.json` (match) |
