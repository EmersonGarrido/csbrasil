...
|---|---:|---|
| Game code | 48,262 lines in 97 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Props in GLB | 177 | `git ls-files 'public/models/props/*.glb' \| wc -l` |
...
| Version | `2.0.0-alpha.254` | `public/js/version.js` and `package.json` (match) |
...
| `parque_treta` | Parque Madureira | **capture** | `map_parque.js` | 975 |
