...
|---|---:|---|
| Game code | 29,239 lines in 38 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Harness scripts | 176 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Pipeline scripts | 53 | `git ls-files 'tools/*.mjs' \| wc -l` |
