...
| Version | `2.0.0-alpha.151` | `public/js/version.js` and `package.json` (match) |
...
`package.json` has **113 scripts**. Keys prefixed with `//` explain why the adjacent command exists.
