...
|---|---:|---|
| Game code | 29,634 lines in 39 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6,560** lines | `wc -l public/js/game.js` |
| `main.js` | 2,491 lines | `wc -l public/js/main.js` |
...
| Version | `2.0.0-alpha.131` | `public/js/version.js` and `package.json` (match) |
...
`package.json` has **104 scripts**. Keys prefixed with `//` explain why the adjacent command exists.
