...
|---|---:|---|
| Game code | 27,522 lines in 33 files | `cat public/js/*.js \| wc -l` |
| `game.js` | **6,435** lines | `wc -l public/js/game.js` |
| `main.js` | 2,000 lines | `wc -l public/js/main.js` |
...
`package.json` has **76 scripts**. Keys prefixed with `//` explain why the adjacent command exists.
