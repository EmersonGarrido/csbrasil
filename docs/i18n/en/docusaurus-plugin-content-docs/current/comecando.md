...
|---|---:|---|
| Game code | 31,758 lines in 44 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6,854** lines | `wc -l public/js/game.js` |
| `main.js` | 2,658 lines | `wc -l public/js/main.js` |
