...
|---|---:|---|
| Game code | 27,950 lines in 35 files | `cat public/js/*.js \| wc -l` |
| `game.js` | **6,467** lines | `wc -l public/js/game.js` |
| `main.js` | 2,023 lines | `wc -l public/js/main.js` |
...
| Version | `2.0.0-alpha.101` | `public/js/version.js` and `package.json` (match) |
...
`package.json` has **91 scripts**. Keys prefixed with `//` explain why the adjacent command exists.
