...
|---|---:|---|
| Game code | 27,661 lines in 34 files | `cat public/js/*.js \| wc -l` |
| `game.js` | **6,454** lines | `wc -l public/js/game.js` |
...
| Version | `2.0.0-alpha.88` | `public/js/version.js` and `package.json` (match) |
