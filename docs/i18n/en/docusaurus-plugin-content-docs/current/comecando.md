...
[what is generated, and what is not](./arquitetura.md#o-que-é-gerado-e-o-que-não-é).
...
> Block generated by `node tools/gen-docs.mjs`. Source: `o comando da coluna direita de cada linha`
...
(see [How to contribute](./colaborar.md#rodar-o-portão)).
:::

## Run it in 3 commands {#rodar-em-3-comandos}
...
### Alternative without Astro (zero build dependency) {#alternativa-sem-astro-zero-dependência-de-build}
...
## The gotcha that costs everyone their first hour {#a-pegadinha-que-custa-a-primeira-hora-de-todo-mundo}
...
## The real repository structure {#estrutura-real-do-repositório}
...
**[Stack and tooling](./stack.md#as-duas-zonas-e-por-que-a-fronteira-é-dura)** — a
...
## Commands you will use {#comandos-que-você-vai-usar}
