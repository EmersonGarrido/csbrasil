...
|---|---:|---|
| Game code | 48,945 lines in 96 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,493** lines | `wc -l public/js/game.js` |
| `main.js` | 3,580 lines | `wc -l public/js/main.js` |
...
| Harness scripts | 399 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
