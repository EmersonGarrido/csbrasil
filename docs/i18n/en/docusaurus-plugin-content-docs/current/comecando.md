...
|---|---:|---|
| Game code | 47,554 lines in 96 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,483** lines | `wc -l public/js/game.js` |
| `main.js` | 3,528 lines | `wc -l public/js/main.js` |
...
| Harness scripts | 373 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Pipeline scripts | 79 | `git ls-files 'tools/*.mjs' \| wc -l` |
| Written entry tasks | 26 | `git ls-files 'docs/issues/[0-9]*.md' \| wc -l` |
| Version | `2.0.0-alpha.252` | `public/js/version.js` and `package.json` (match) |
...
| `penitenciaria` | Penitenciária da Treta | **capture** | `map_penitenciaria.js` | 248 |
...
`package.json` has **241 scripts**; the reason behind each one lives in `SCRIPTS.md`.
