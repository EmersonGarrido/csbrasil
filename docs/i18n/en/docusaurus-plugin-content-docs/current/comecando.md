...
|---|---:|---|
| Game code | 49,180 lines in 96 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,522** lines | `wc -l public/js/game.js` |
| `main.js` | 3,591 lines | `wc -l public/js/main.js` |
