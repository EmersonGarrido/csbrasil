...
|---|---:|---|
| Game code | 31,726 lines in 44 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6,839** lines | `wc -l public/js/game.js` |
| `main.js` | 2,641 lines | `wc -l public/js/main.js` |
