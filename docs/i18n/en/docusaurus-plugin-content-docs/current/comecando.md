...
|---|---:|---|
| Game code | 28,427 lines in 36 files | `cat public/js/*.js \| wc -l` |
...
| Version | `2.0.0-alpha.106` | `public/js/version.js` and `package.json` (match) |
...
`package.json` has **92 scripts**. Keys prefixed with `//` explain why the adjacent command exists.
