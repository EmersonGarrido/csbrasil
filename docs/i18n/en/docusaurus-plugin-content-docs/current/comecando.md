...
|---|---:|---|
| Game code | 49,980 lines in 97 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Harness scripts | 415 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Pipeline scripts | 80 | `git ls-files 'tools/*.mjs' \| wc -l` |
| Written entry tasks | 26 | `git ls-files 'docs/issues/[0-9]*.md' \| wc -l` |
| Version | `2.0.0-alpha.283` | `public/js/version.js` and `package.json` (match) |
