...
|---|---:|---|
| Game code | 31,798 lines in 44 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6,892** lines | `wc -l public/js/game.js` |
...
| Version | `2.0.0-alpha.166` | `public/js/version.js` and `package.json` (match) |
