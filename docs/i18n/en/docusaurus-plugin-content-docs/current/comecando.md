...
|---|---:|---|
| Game code | 49,619 lines in 97 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,483** lines | `wc -l public/js/game.js` |
| `main.js` | 3,571 lines | `wc -l public/js/main.js` |
...
| Harness scripts | 401 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
