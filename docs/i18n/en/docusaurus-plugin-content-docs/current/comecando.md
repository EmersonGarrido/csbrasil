...
|---|---:|---|
| Game code | 28,763 lines in 37 files | `cat public/js/*.js \| wc -l` |
| `game.js` | **6,483** lines | `wc -l public/js/game.js` |
| `main.js` | 2,046 lines | `wc -l public/js/main.js` |
...
| Maps in the registry | 7 | `MAPS` object in `maps.js` |
| Visual harnesses in HTML | 14 | `ls public/*.html \| wc -l` |
| Harness scripts | 169 | `ls tools/eval/*.mjs tools/eval/*.py \| wc -l` |
| Pipeline scripts | 48 | `ls tools/*.mjs \| wc -l` |
| Written entry tasks | 26 | `ls docs/issues/[0-9]*.md \| wc -l` |
| Version | `2.0.0-alpha.119` | `public/js/version.js` and `package.json` (match) |
...
| Maps in the menu | 7 - 2 open in rounds, **5 in capture** | `MAPS` / `ctfMode` |
...
`package.json` has **93 scripts**. Keys prefixed with `//` explain why the adjacent command exists.
