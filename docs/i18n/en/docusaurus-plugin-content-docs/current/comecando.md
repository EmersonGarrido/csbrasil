...
|---|---:|---|
| Game code | 29,239 lines in 38 files | `cat public/js/*.js \| wc -l` |
| `game.js` | **6,533** lines | `wc -l public/js/game.js` |
| `main.js` | 2,398 lines | `wc -l public/js/main.js` |
...
| Harness scripts | 179 | `ls tools/eval/*.mjs tools/eval/*.py \| wc -l` |
...
`package.json` has **101 scripts**. Keys prefixed with `//` explain why the adjacent command exists.
