...
|---|---:|---|
| Game code | 47,626 lines in 96 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,483** lines | `wc -l public/js/game.js` |
| `main.js` | 3,569 lines | `wc -l public/js/main.js` |
...
`package.json` has **242 scripts**; the reason behind each one lives in `SCRIPTS.md`.
