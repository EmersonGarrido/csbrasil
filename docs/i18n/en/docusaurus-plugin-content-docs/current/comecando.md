...
|---|---:|---|
| Game code | 30,806 lines in 42 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6,521** lines | `wc -l public/js/game.js` |
| `main.js` | 2,581 lines | `wc -l public/js/main.js` |
...
| Version | `2.0.0-alpha.143` | `public/js/version.js` and `package.json` (match) |
