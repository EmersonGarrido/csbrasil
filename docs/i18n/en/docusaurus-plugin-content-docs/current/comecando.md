...
|---|---:|---|
| Game code | 50,100 lines in 97 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,532** lines | `wc -l public/js/game.js` |
| `main.js` | 3,600 lines | `wc -l public/js/main.js` |
...
| Props in GLB | 179 | `git ls-files 'public/models/props/*.glb' \| wc -l` |
...
| Harness scripts | 417 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Pipeline scripts | 80 | `git ls-files 'tools/*.mjs' \| wc -l` |
| Written entry tasks | 26 | `git ls-files 'docs/issues/[0-9]*.md' \| wc -l` |
| Version | `2.0.0-alpha.286` | `public/js/version.js` and `package.json` (match) |
...
| `praca_poderes` | Praça dos Três Poderes | rounds | `map_brasilia.js` | 1,974 |
| `piscina_treta` | Piscina da Treta | rounds | `map_piscina.js` | 1,041 |
| `loja_h` | Loja H (Estacionamento) | **capture** | `map_havan.js` | 2,015 |
| `ferro_velho` | Ferro Velho do Zé | **capture** | `map_ferrovelho.js` | 2,009 |
...
`package.json` has **257 scripts**; the reason behind each one lives in `SCRIPTS.md`.
