...
|---|---:|---|
| Game code | 28,750 lines in 37 files | `cat public/js/*.js \| wc -l` |
| `game.js` | **6,483** lines | `wc -l public/js/game.js` |
| `main.js` | 2,048 lines | `wc -l public/js/main.js` |
...
| Version | `2.0.0-alpha.117` | `public/js/version.js` and `package.json` (match) |
