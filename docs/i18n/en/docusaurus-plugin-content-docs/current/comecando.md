...
|---|---:|---|
| Game code | 29,599 lines in 39 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6,559** lines | `wc -l public/js/game.js` |
| `main.js` | 2,471 lines | `wc -l public/js/main.js` |
...
| Version | `2.0.0-alpha.128` | `public/js/version.js` and `package.json` (match) |
