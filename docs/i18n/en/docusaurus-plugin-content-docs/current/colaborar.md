...
**9 human author identities** sign commits in this branch: `ruben-cytonic`, `Emerson Garrido`, `rubenmarcus`, `Ruben`, `Ruben Marcus`, `William Oliveira`, `Juan Versolato Lopes`, `matheusgb`, `daltonfontes`. Automated identities are excluded. A Git author name is not necessarily one unique person.
...
content-as-data of
[`docs/ROADMAP.md`](https://github.com/corosolto/client/blob/main/docs/ROADMAP.md), and it is the
...
The entry tasks live in **[`docs/issues/`](https://github.com/corosolto/client/tree/main/docs/issues)**,
