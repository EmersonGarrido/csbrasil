...
| rodapé desta documentação | `docs/docusaurus.config.js` | linha 126  |
...
`AGPL` já aparece em `README.md` (linhas 329, 335), `CONTRIBUTING.md` (linha 177), `src/pages/sobre.astro` (linha 122), `public/llms.txt` (linha 47) — como **aviso de mudança planejada**, não como declaração. A regra é essa: nenhum arquivo pode DECLARAR `AGPL` antes de o `LICENSE` dizer.
