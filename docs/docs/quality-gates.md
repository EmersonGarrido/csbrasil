...
- `tools/eval/invariants.mjs`: **2.322 linhas**, **68 identificadores de invariante declarados** (`put()`), dos quais **29** têm caminho de `skip()` declarado.
- O arnês inteiro são **386 scripts** em `tools/eval/` (`.mjs` + `.py`), mais **76 scripts** de pipeline em `tools/`.
