...
- `tools/eval/invariants.mjs`: **2.208 linhas**, **62 identificadores de invariante declarados** (`put()`), dos quais **27** têm caminho de `skip()` declarado.
- O arnês inteiro são **174 scripts** em `tools/eval/` (`.mjs` + `.py`), mais **46 scripts** de pipeline em `tools/`.
