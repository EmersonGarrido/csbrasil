...
|---|---:|---|
| Código do jogo | 48.262 linhas em 97 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Props em GLB | 177 | `git ls-files 'public/models/props/*.glb' \| wc -l` |
...
| Versão | `2.0.0-alpha.254` | `public/js/version.js` e `package.json` (batem) |
...
| `parque_treta` | Parque Madureira | **captura** | `map_parque.js` | 975 |
