...
|---|---:|---|
| Código do jogo | 48.978 linhas em 96 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.483** linhas | `wc -l public/js/game.js` |
| `main.js` | 3.571 linhas | `wc -l public/js/main.js` |
...
| Scripts do arnês | 398 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` tem **248 scripts**; o motivo de cada um mora em `SCRIPTS.md` (migrado das chaves `//nome` em 18/08/2026) — é onde está o porquê.
