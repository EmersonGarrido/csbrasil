...
|---|---:|---|
| Código do jogo | 48.392 linhas em 96 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.483** linhas | `wc -l public/js/game.js` |
| `main.js` | 3.537 linhas | `wc -l public/js/main.js` |
