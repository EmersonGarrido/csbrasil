...
|---|---:|---|
| Código do jogo | 27.135 linhas em 31 arquivos | `cat public/js/*.js \| wc -l` |
| `game.js` | **6.238** linhas | `wc -l public/js/game.js` |
| `main.js` | 1.922 linhas | `wc -l public/js/main.js` |
...
| Versão | `2.0.0-alpha.59` | `public/js/version.js` e `package.json` (batem) |
