...
|---|---:|---|
| Código do jogo | 47.540 linhas em 96 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.475** linhas | `wc -l public/js/game.js` |
| `main.js` | 3.522 linhas | `wc -l public/js/main.js` |
...
| Scripts do arnês | 371 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` tem **239 scripts**; o motivo de cada um mora em `SCRIPTS.md` (migrado das chaves `//nome` em 18/08/2026) — é onde está o porquê.
