...
|---|---:|---|
| Código do jogo | 31.798 linhas em 44 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6.892** linhas | `wc -l public/js/game.js` |
...
| Versão | `2.0.0-alpha.166` | `public/js/version.js` e `package.json` (batem) |
