...
|---|---:|---|
| Código do jogo | 48.479 linhas em 96 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.523** linhas | `wc -l public/js/game.js` |
| `main.js` | 3.575 linhas | `wc -l public/js/main.js` |
...
| Versão | `2.0.0-alpha.267` | `public/js/version.js` e `package.json` (batem) |
