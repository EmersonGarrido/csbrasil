...
|---|---:|---|
| Código do jogo | 49.619 linhas em 97 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Scripts do arnês | 401 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
