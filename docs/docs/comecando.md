...
|---|---:|---|
| Código do jogo | 29.634 linhas em 39 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6.560** linhas | `wc -l public/js/game.js` |
| `main.js` | 2.491 linhas | `wc -l public/js/main.js` |
...
| Versão | `2.0.0-alpha.131` | `public/js/version.js` e `package.json` (batem) |
...
`package.json` tem **104 scripts**. Vários trazem uma chave `//nome` logo acima com o motivo de existirem — é onde mora o porquê.
