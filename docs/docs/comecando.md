...
|---|---:|---|
| Código do jogo | 49.208 linhas em 96 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Scripts do arnês | 409 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Scripts de pipeline | 76 | `git ls-files 'tools/*.mjs' \| wc -l` |
| Tarefas de entrada escritas | 26 | `git ls-files 'docs/issues/[0-9]*.md' \| wc -l` |
| Versão | `2.0.0-alpha.278` | `public/js/version.js` e `package.json` (batem) |
