...
|---|---:|---|
| Código do jogo | 27.086 linhas em 31 arquivos | `cat public/js/*.js \| wc -l` |
| `game.js` | **6.203** linhas | `wc -l public/js/game.js` |
| `main.js` | 1.908 linhas | `wc -l public/js/main.js` |
...
| Versão | `2.0.0-alpha.58` | `public/js/version.js` e `package.json` (batem) |
