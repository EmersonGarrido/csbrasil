...
|---|---:|---|
| Código do jogo | 47.572 linhas em 96 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.483** linhas | `wc -l public/js/game.js` |
| `main.js` | 3.529 linhas | `wc -l public/js/main.js` |
...
| Versão | `2.0.0-alpha.253` | `public/js/version.js` e `package.json` (batem) |
