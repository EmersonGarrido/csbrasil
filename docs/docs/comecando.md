...
|---|---:|---|
| Código do jogo | 47.554 linhas em 96 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Scripts do arnês | 373 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Scripts de pipeline | 79 | `git ls-files 'tools/*.mjs' \| wc -l` |
| Tarefas de entrada escritas | 26 | `git ls-files 'docs/issues/[0-9]*.md' \| wc -l` |
| Versão | `2.0.0-alpha.251` | `public/js/version.js` e `package.json` (batem) |
