...
|---|---:|---|
| Código do jogo | 29.575 linhas em 39 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6.558** linhas | `wc -l public/js/game.js` |
| `main.js` | 2.448 linhas | `wc -l public/js/main.js` |
