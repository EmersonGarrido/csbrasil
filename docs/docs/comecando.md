...
|---|---:|---|
| Código do jogo | 50.100 linhas em 97 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Scripts do arnês | 417 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Scripts de pipeline | 80 | `git ls-files 'tools/*.mjs' \| wc -l` |
| Tarefas de entrada escritas | 26 | `git ls-files 'docs/issues/[0-9]*.md' \| wc -l` |
| Versão | `2.0.0-alpha.284` | `public/js/version.js` e `package.json` (batem) |
...
`package.json` tem **257 scripts**; o motivo de cada um mora em `SCRIPTS.md` (migrado das chaves `//nome` em 18/08/2026) — é onde está o porquê.
