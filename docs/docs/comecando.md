...
|---|---:|---|
| Código do jogo | 48.411 linhas em 96 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.494** linhas | `wc -l public/js/game.js` |
| `main.js` | 3.545 linhas | `wc -l public/js/main.js` |
