...
|---|---:|---|
| Código do jogo | 47.632 linhas em 96 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Scripts do arnês | 377 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
| `amazonia` | Treta na Amazônia | **captura** | `map_amazonia.js` | 1.195 |
...
`package.json` tem **242 scripts**; o motivo de cada um mora em `SCRIPTS.md` (migrado das chaves `//nome` em 18/08/2026) — é onde está o porquê.
