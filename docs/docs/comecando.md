...
|---|---:|---|
| Código do jogo | 29.618 linhas em 39 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6.557** linhas | `wc -l public/js/game.js` |
| `main.js` | 2.478 linhas | `wc -l public/js/main.js` |
...
| Versão | `2.0.0-alpha.129` | `public/js/version.js` e `package.json` (batem) |
...
`package.json` tem **103 scripts**. Vários trazem uma chave `//nome` logo acima com o motivo de existirem — é onde mora o porquê.
