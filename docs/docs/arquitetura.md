...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 6.467 |
| `public/js/main.js` | 2.023 |
...
Total de `public/js/`: **27.950 linhas em 35 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
