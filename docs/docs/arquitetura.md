...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 6.262 |
| `public/js/main.js` | 1.860 |
...
Total de `public/js/`: **27.208 linhas em 33 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
