...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 6.195 |
| `public/js/main.js` | 1.743 |
...
Total de `public/js/`: **26.912 linhas em 31 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
