...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 6.400 |
| `public/js/main.js` | 2.160 |
...
Total de `public/js/`: **29.702 linhas em 40 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
