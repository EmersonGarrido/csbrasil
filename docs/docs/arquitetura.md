...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 6.495 |
| `public/js/main.js` | 2.065 |
...
Total de `public/js/`: **28.779 linhas em 37 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
