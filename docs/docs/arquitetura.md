...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 6.527 |
| `public/js/main.js` | 1.597 |
...
Total de `public/js/`: **25.269 linhas em 28 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
