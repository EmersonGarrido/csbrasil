...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 6.839 |
| `public/js/main.js` | 2.641 |
...
Total de `public/js/`: **31.726 linhas em 44 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
