...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 6.238 |
| `public/js/main.js` | 1.941 |
...
Total de `public/js/`: **27.154 linhas em 31 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
