...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 6.559 |
| `public/js/main.js` | 2.471 |
...
Total de `public/js/`: **29.599 linhas em 39 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
