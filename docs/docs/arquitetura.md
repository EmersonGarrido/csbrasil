...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 6.288 |
| `public/js/main.js` | 1.951 |
...
Total de `public/js/`: **27.326 linhas em 33 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
