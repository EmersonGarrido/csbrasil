...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 6.483 |
| `public/js/main.js` | 2.048 |
...
Total de `public/js/`: **28.750 linhas em 37 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
