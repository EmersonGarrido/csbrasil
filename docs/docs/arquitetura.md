...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.522 |
| `public/js/main.js` | 3.591 |
...
Total de `public/js/`: **49.179 linhas em 96 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
