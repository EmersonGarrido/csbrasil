...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 6.517 |
| `public/js/main.js` | 2.478 |
...
Total de `public/js/`: **29.578 linhas em 39 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
