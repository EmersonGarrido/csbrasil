...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.494 |
| `public/js/main.js` | 3.580 |
...
Total de `public/js/`: **48.718 linhas em 96 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
