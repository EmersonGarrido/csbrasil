...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.532 |
| `public/js/main.js` | 3.600 |
...
Total de `public/js/`: **49.659 linhas em 96 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
