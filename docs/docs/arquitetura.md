...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.475 |
| `public/js/main.js` | 3.522 |
...
Total de `public/js/`: **47.542 linhas em 96 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
