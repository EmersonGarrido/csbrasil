...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.493 |
| `public/js/main.js` | 3.596 |
...
Total de `public/js/`: **49.244 linhas em 96 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
