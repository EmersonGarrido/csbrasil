...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 6.435 |
| `public/js/main.js` | 2.000 |
| `public/js/characters.js` | 1.053 |
| `public/js/glbchars.js` | 837 |
| `public/js/vmattach.js` | 628 |
| `public/js/weapons.js` | 344 |
| `public/js/springs.js` | 260 |

Total de `public/js/`: **27.522 linhas em 33 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
