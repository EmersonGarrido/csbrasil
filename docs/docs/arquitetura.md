...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 6.521 |
| `public/js/main.js` | 2.581 |
...
Total de `public/js/`: **30.806 linhas em 42 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
