...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 6.533 |
| `public/js/main.js` | 2.398 |
...
Total de `public/js/`: **29.239 linhas em 38 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
