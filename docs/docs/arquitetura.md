...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 6.158 |
| `public/js/main.js` | 1.707 |
...
Total de `public/js/`: **26.839 linhas em 31 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
