...
export const PERSONAGENS: Personagem[] = [
  { faccao: 'P', nome: 'Esquerdomacho', blurb: 'Barba, tote bag e 47 bottons. Mira acadêmica: analisa a treta antes de atirar.' },
  { faccao: 'P', nome: 'Líder do Sindicato', blurb: 'Boné vermelho, colete de assembleia e megafone. Convoca greve de fogo a cada round.' },
  { faccao: 'P', nome: 'Líder do MST', blurb: 'Do campo pra arena. Bandeira na mochila, bota no barro e tiro certeiro de enxada.' },
  { faccao: 'P', nome: 'Doutora do SUS', blurb: 'Jaleco, estetoscópio e plantão de 24h. Receita tiro certeiro, na veia.' },
  { faccao: 'P', nome: 'Jovem Místico', blurb: 'Faixa na testa, cristal no peito e aura calibrada. Só atira quando Mercúrio permite.' },
  { faccao: 'P', nome: 'Zé da Gotinha', blurb: 'Mascote da saúde. Imuniza a treta com dose de reforço — e ainda pega o SUS de graça.' },
  { faccao: 'P', nome: 'Hipster Alternativo', blurb: 'Moicano colorido e camiseta de banda que você não conhece. Já jogava isso antes de ser mainstream.' },
  { faccao: 'P', nome: 'ET de Varginha', blurb: 'Veio de longe pra treta. Abduz a direita e some no mato de Minas.' },

  { faccao: 'B', nome: 'Caminhoneiro', blurb: 'Camisa do Brasil, luva de estrada e 40h de BR na semana. Freia pra ninguém.' },
  { faccao: 'B', nome: 'Cantor Sertanejo', blurb: 'Chapéu de cowboy, fivela de ouro e violão nas costas. Moda de viola em dose dupla.' },
  { faccao: 'B', nome: 'Coach Quântico', blurb: 'Blazer, headset e 47 técnicas de manifestação. Já venceu antes de começar — no quântico.' },
  { faccao: 'B', nome: 'Faria Limer', blurb: 'Colete, sapatênis e planilha de day trade. Compra na baixa, atira na alta.' },
  { faccao: 'B', nome: 'Bombado da Academia', blurb: 'Peitoral gigante, perna de palito. Pulou o leg day pra treinar o gatilho.' },
  { faccao: 'B', nome: 'Dollynho', blurb: 'Mascote do guaraná polêmico. Efervescente, gelado e sempre do contra.' },
  { faccao: 'B', nome: 'Ancap Medieval', blurb: 'Cota de malha, cruz templária e capa verde-amarela. Privatiza a treta e xinga o Banco Central.' },
  { faccao: 'B', nome: 'Canarinho Pistola', blurb: 'Pistola desde 2016. Bico torto, peito estufado e camisa 24: ele NÃO amarela.' },
  { faccao: 'B', nome: 'Leão do Proerd', blurb: 'Camisa preta colada, rugido de mascote de formatura e garra afiada na defesa da treta.' },

  { faccao: 'urbanas', nome: 'Emo', blurb: 'Franja na cara e playlist de sofrência. Mira embaçada por um olho só.' },
  { faccao: 'urbanas', nome: 'Black Metal', blurb: 'Corpse paint, cabelão e blast beat. Congela a treta num inverno norueguês.' },
  { faccao: 'urbanas', nome: 'Metaleiro', blurb: 'Jaqueta jeans coberta de bottons e cabelo até a cintura. Headbang no recuo.' },
  { faccao: 'urbanas', nome: 'Punk', blurb: 'Moicano colorido e jaqueta de spikes. Anarquia, três acordes e um tiro só.' },
  { faccao: 'urbanas', nome: 'Skatista', blurb: 'Gorro, camiseta larga e joelho ralado. Dropa a treta de flip.' },
  { faccao: 'urbanas', nome: 'Clubber', blurb: 'Regata neon e glowstick. Só atira no drop da batida.' },
  { faccao: 'urbanas', nome: 'Rapper', blurb: 'Camisão gigante, correntes de ouro e calça saggy. Rima e recarrega no flow.' },
  { faccao: 'urbanas', nome: 'Rasta', blurb: 'Dreads, gorro rastafári e paz interior. Só que armado. Jah guia a mira.' },
  { faccao: 'urbanas', nome: 'Pagodeiro', blurb: 'Platinado, roupa toda branca e corrente de ouro. Canta o hit e acerta o tiro no refrão.' },

  { faccao: 'palhacos', nome: 'Bonzo', blurb: 'Do picadeiro pra praça. Nariz vermelho, sapatão marrom e risada de quem arma o circo.' },
  { faccao: 'palhacos', nome: 'Palhaço do Mal', blurb: 'Riso que gela a espinha. Sai do picadeiro direto pro pesadelo — e ainda cobra ingresso.' },
  { faccao: 'palhacos', nome: 'Jozo', blurb: 'Mascote de lanche pirata. Fritou o juízo no óleo e agora só serve treta com batata.' },
  { faccao: 'palhacos', nome: 'Adjim', blurb: 'Espirra, ri e atira. Metade da dupla que faz a criançada chorar de rir (e de medo).' },
  { faccao: 'palhacos', nome: 'Esbirro', blurb: 'A outra metade da dupla. Buzina no gatilho e resenha no recuo.' },
  { faccao: 'palhacos', nome: 'Titica', blurb: 'Do circo pro Congresso e do Congresso pra arena, sempre no bom humor e no gatilho leve.' },
  { faccao: 'palhacos', nome: 'Padati', blurb: 'Um da dupla mais colorida do picadeiro. Cambalhota, buzina e mira infantil.' },
  { faccao: 'palhacos', nome: 'Padata', blurb: 'O outro da dupla. Se um erra, o outro acerta — geralmente na risada.' },
  { faccao: 'palhacos', nome: 'Cadequinha', blurb: 'Clássico dos clássicos. Cartola, xadrez e uma gargalhada que atravessa gerações.' },

  { faccao: 'funkeiros', nome: 'Mandrake', blurb: 'Boné, Juliet vermelho e corrente de ouro. Ostenta e domina na quebrada.' },
  { faccao: 'funkeiros', nome: 'Raul da Franja', blurb: 'Franja açucarada, camisa de grife e cordão de ouro falso. Desfila antes de atirar.' },
  { faccao: 'funkeiros', nome: 'Oakley', blurb: 'Chapéu Medusa, colete tático e tattoo no braço. O corre só passa por ele.' },
  { faccao: 'funkeiros', nome: 'Cria RJ', blurb: 'Cabelo zebrado platinado e camisa de time. Cria do morro, mira de craque.' },
  { faccao: 'funkeiros', nome: 'Chave SP', blurb: 'Polo, boné e óculos escuros. Só entra na treta se for chave.' },
  { faccao: 'funkeiros', nome: 'Funk Raiz', blurb: 'Tamborzão na cabeça e passinho no recuo. O funk mais velho da arena.' },
  { faccao: 'funkeiros', nome: 'Trap Funk', blurb: 'Autotune no grito de guerra e 808 no peito. Trap em dose dupla.' },
  { faccao: 'funkeiros', nome: 'Fluxo', blurb: 'Óculos espelhado e corte na régua. No fluxo, quem corre é a bala.' },
  { faccao: 'funkeiros', nome: 'Ostentação', blurb: 'Corrente, anel e relógio brilhando. Se é pra atirar, que seja com estilo.' },
];
