...
|---|---|---|---|
| `public/` | o **jogo** | 40 arquivos `.js`, 29.702 linhas · Three.js `r160` vendorizado | ES modules servidos crus, **zero build**, sem dependência de runtime |
...
`package.json` tem **69 scripts**. Vários trazem uma chave `//nome` logo acima com o motivo de existirem — é onde mora o porquê.
