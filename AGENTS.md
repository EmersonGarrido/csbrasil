...
|---|---|---|---|
| `public/` | o **jogo** | 30 arquivos `.js`, 26.991 linhas · Three.js `r160` vendorizado | ES modules servidos crus, **zero build**, sem dependência de runtime |
| `src/` | o **site** | 17 páginas `.astro`, 12 rotas `/api` · Astro `^7.1.1` | framework é bem-vindo; `service_role` só no servidor |
| `tools/` | o **arnês** | 157 scripts em `tools/eval/`, 44 em `tools/` | node puro: sobe o jogo real sem browser |
