...
|---|---|---|---|
| `public/` | o **jogo** | 27 arquivos `.js`, 25.082 linhas · Three.js `r160` vendorizado | ES modules servidos crus, **zero build**, sem dependência de runtime |
| `src/` | o **site** | 10 páginas `.astro`, 9 rotas `/api` · Astro `^7.1.1` | framework é bem-vindo; `service_role` só no servidor |
