...
|---|---|---|---|
| `public/` | o **jogo** | 35 arquivos `.js`, 27.958 linhas · Three.js `r160` vendorizado | ES modules servidos crus, **zero build**, sem dependência de runtime |
| `src/` | o **site** | 17 páginas `.astro`, 19 rotas `/api` · Astro `^7.1.1` | framework é bem-vindo; `service_role` só no servidor |
| `tools/` | o **arnês** | 168 scripts em `tools/eval/`, 47 em `tools/` | node puro: sobe o jogo real sem browser |
