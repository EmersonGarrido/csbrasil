...
|---|---|---|---|
| `public/` | o **jogo** | 31 arquivos `.js`, 26.778 linhas · Three.js `r160` vendorizado | ES modules servidos crus, **zero build**, sem dependência de runtime |
| `src/` | o **site** | 17 páginas `.astro`, 13 rotas `/api` · Astro `^7.1.1` | framework é bem-vindo; `service_role` só no servidor |
| `tools/` | o **arnês** | 162 scripts em `tools/eval/`, 44 em `tools/` | node puro: sobe o jogo real sem browser |
