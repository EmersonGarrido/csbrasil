...
const MAP_DESC = {
  ...
  quebrada: 'Rua reta do baile: rotunda numa ponta, campinho de terra na outra e quatro bandeiras no meio da treta.',
  posto_treta: 'Posto de beira de estrada na hora dourada: loja, marquise e pátio — três corredores e nenhum lugar seguro.',
};
function renderMapScreen() {
  ...
  const cb = $('ms-community'); if (cb) cb.classList.toggle('hidden', !mapa.community);
